...
using NoelBlogReader.XamlTypeInfo;
...
namespace NoelBlogReader.XamlTypeInfo
{
    ...
    internal partial class XamlTypeInfoProvider
    {
        ...
        private object Activate_0_DateConverter() { return new NoelBlogReader.DateConverter(); }

        private object Activate_1_BlankPage() { return new NoelBlogReader.BlankPage(); }

        private object Activate_2_LayoutAwarePage() { return new NoelBlogReader.Common.LayoutAwarePage(); }

        private object Activate_3_RichTextColumns() { return new NoelBlogReader.Common.RichTextColumns(); }

        private object Activate_4_DetailPage() { return new NoelBlogReader.DetailPage(); }

        private object Activate_5_ItemsPage() { return new NoelBlogReader.ItemsPage(); }

        private object Activate_6_SplitPage() { return new NoelBlogReader.SplitPage(); }
        ...
        private IXamlType CreateXamlType(string typeName)
        {
            ...
            case "NoelBlogReader.DateConverter":
                userType = new XamlUserType(this, typeName, typeof(NoelBlogReader.DateConverter), GetXamlTypeByName("Object"));
                userType.Activator = Activate_0_DateConverter;
                xamlType = userType;
                break;

            case "NoelBlogReader.BlankPage":
                userType = new XamlUserType(this, typeName, typeof(NoelBlogReader.BlankPage), GetXamlTypeByName("Windows.UI.Xaml.Controls.Page"));
                userType.Activator = Activate_1_BlankPage;
                xamlType = userType;
                break;

            case "NoelBlogReader.Common.LayoutAwarePage":
                userType = new XamlUserType(this, typeName, typeof(NoelBlogReader.Common.LayoutAwarePage), GetXamlTypeByName("Windows.UI.Xaml.Controls.Page"));
                userType.Activator = Activate_2_LayoutAwarePage;
                userType.AddMemberName("UseFilledStateForNarrowWindow", "NoelBlogReader.Common.LayoutAwarePage.UseFilledStateForNarrowWindow");
                xamlType = userType;
                break;

            case "NoelBlogReader.Common.RichTextColumns":
                userType = new XamlUserType(this, typeName, typeof(NoelBlogReader.Common.RichTextColumns), GetXamlTypeByName("Windows.UI.Xaml.Controls.Panel"));
                userType.Activator = Activate_3_RichTextColumns;
                userType.SetContentPropertyName("NoelBlogReader.Common.RichTextColumns.RichTextContent");
                userType.AddMemberName("RichTextContent", "NoelBlogReader.Common.RichTextColumns.RichTextContent");
                userType.AddMemberName("ColumnTemplate", "NoelBlogReader.Common.RichTextColumns.ColumnTemplate");
                xamlType = userType;
                break;

            case "NoelBlogReader.DetailPage":
                userType = new XamlUserType(this, typeName, typeof(NoelBlogReader.DetailPage), GetXamlTypeByName("NoelBlogReader.Common.LayoutAwarePage"));
                userType.Activator = Activate_4_DetailPage;
                xamlType = userType;
                break;

            case "NoelBlogReader.ItemsPage":
                userType = new XamlUserType(this, typeName, typeof(NoelBlogReader.ItemsPage), GetXamlTypeByName("NoelBlogReader.Common.LayoutAwarePage"));
                userType.Activator = Activate_5_ItemsPage;
                xamlType = userType;
                break;

            case "NoelBlogReader.SplitPage":
                userType = new XamlUserType(this, typeName, typeof(NoelBlogReader.SplitPage), GetXamlTypeByName("NoelBlogReader.Common.LayoutAwarePage"));
                userType.Activator = Activate_6_SplitPage;
                xamlType = userType;
                break;
        ...
        {
            var that = (NoelBlogReader.Common.LayoutAwarePage)instance;
        ...
        {
            var that = (NoelBlogReader.Common.RichTextColumns)instance;
        ...
        private IXamlMember CreateXamlMember(string longMemberName)
        {
            ...
            {
            case "NoelBlogReader.Common.LayoutAwarePage.UseFilledStateForNarrowWindow":
                userType = (XamlUserType)GetXamlTypeByName("NoelBlogReader.Common.LayoutAwarePage");
                ...
                break;
            case "NoelBlogReader.Common.RichTextColumns.RichTextContent":
                userType = (XamlUserType)GetXamlTypeByName("NoelBlogReader.Common.RichTextColumns");
                ...
                break;
            case "NoelBlogReader.Common.RichTextColumns.ColumnTemplate":
                userType = (XamlUserType)GetXamlTypeByName("NoelBlogReader.Common.RichTextColumns");
